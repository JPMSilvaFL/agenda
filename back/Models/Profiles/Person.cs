...
public class Person {
	...
	[Length(11, 14)] public string Document { get; set; } = string.Empty;
	[MaxLength(1)] public string Type { get; set; } = string.Empty;
	[MaxLength(13)] public string Phone { get; set; } = string.Empty;
	[Length(10, 100)] public string Address { get; set; } = string.Empty;
