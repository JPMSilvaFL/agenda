...
namespace AgendaApi.Migrations
{
    ...
    [Migration("20250616172019_AlterBaseOfProfiles")]
    partial class AlterBaseOfProfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgendaApi.Models.Utilities.LogActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgendaApi.Models.Profiles.Customer", b =>
                {
                    b.HasOne("AgendaApi.Models.Profiles.User", "FromUser")
                        .WithOne()
                        .HasForeignKey("AgendaApi.Models.Profiles.Customer", "IdUser")
            ...
            modelBuilder.Entity("AgendaApi.Models.Profiles.Employee", b =>
                {
                    ...
                    b.HasOne("AgendaApi.Models.Profiles.User", "FromUser")
                        .WithOne()
                        .HasForeignKey("AgendaApi.Models.Profiles.Employee", "IdUser")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
